...
class DishesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dishes = [
            ...
            ['restaurant_id' => 2, 'name' => "Spaghetti Vongole", 'description' => "Spaghetti conditi con vongole veraci, aglio, olio extravergine d'oliva e un pizzico di peperoncino.", 'price' => 13.50,'path_img'=>'dishes/risotto-allo-zafferano.jpg'],
